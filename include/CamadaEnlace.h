...
void CamadaEnlaceDadosTransmissoraControleDeErroCodigoDeHamming(std::vector<bool>&);
...
void CamadaEnlaceDadosReceptoraControleDeErroCodigoDeHamming(std::vector<bool>&);
